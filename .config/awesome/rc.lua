...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey  }, "[", function () lain.util.useless_gaps_resize(7) end,
    ...
    -- Prompt
    awful.key({ modkey }, "d", function () awful.util.spawn("dmenu_run -fn 'Source Code Pro Regular-8' -i -l 10 -p 'Run:' -nb '#2d2d2d' -nf '#cccccc' -sb '#ff033e' -sf '#38000d'") end),
    awful.key({ modkey }, "o", function () awful.screen.focused().mypromptbox:run() end,
