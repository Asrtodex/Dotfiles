...
-- }}}
-- {{{
-- run once  function to startup some apps
...
awful.rules.rules = {
    ...
    -- Set firefox to be able to tile
    { rule = { class = "firefox" },
...
--awful.spawn.with_shell("feh --bg-fill ~/Pictures/N001.jpg") -- feh sets wallpaper
